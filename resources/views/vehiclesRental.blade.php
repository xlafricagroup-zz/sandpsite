                                ...
                                <div class="wpb_column column_container col-sm-12">
                                    <div class="column-inner">
                                        <div class="wpb_wrapper">
                                            <h3>Security Vehicles Rental Services</h3>
                                            <div class="wpb_text_column wpb_content_element">
                                                <div class="wpb_wrapper">
                                                    <p>Due to popular demands from the clients, we ventured into security vehicle rentals where our clients are happy to be associated with us as we take the issue of maintenance and servicing seriously coupled with very professional spy drivers put behind the wheels.</p>
                                                </div>
                                            </div>
